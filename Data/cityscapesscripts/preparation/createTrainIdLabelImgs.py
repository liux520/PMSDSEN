...
if __name__ == "__main__":
    ROOTPATH = os.path.abspath(os.path.join(__file__, os.path.pardir, os.path.pardir, os.path.pardir, os.path.pardir))
    cityscapesPath = os.path.join(ROOTPATH, 'Datasets', 'Cityscapes')
    main(cityscapesPath)

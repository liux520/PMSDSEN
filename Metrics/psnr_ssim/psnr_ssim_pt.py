...
if __name__ == '__main__':
    ...
    class dataset(Dataset):
        def __init__(self):
            ...
            self.images=glob.glob(r'F:\Software\professional\PyCharm\Pytorch\Code\Dataset\DIV2K_valid_HR\*.png')
        ...
        def __getitem__(self, item):
            ...
            hr=self.hr_trans(img)
            lr=self.lr_trans(hr)
            hr,lr=self.totensor(hr),self.totensor(lr)
            return hr,lr
        def __len__(self):
